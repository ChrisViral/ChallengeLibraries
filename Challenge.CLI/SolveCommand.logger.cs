...
public partial class SolveCommand
{
    ...
    static partial void LogFetchingInput(ILogger logger, string challenge, uint year, uint day, string module);

    [LoggerMessage(LogLevel.Error, "Could not fetch input for {Challenge} {Year} {Day}{Module}: {Error}")]
    static partial void LogInputFetchFailed(ILogger logger, string challenge, uint year, uint day, string module, string error);
    ...
    static partial void LogRunSolver(ILogger logger, string challenge, uint year, uint day, string module);
    ...
    static partial void LogExceptionWhileRunningSolver(ILogger logger, string challenge, uint year, uint day, string module, Exception exception);
