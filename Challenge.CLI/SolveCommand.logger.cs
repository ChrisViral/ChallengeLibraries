...
public partial class SolveCommand
{
    ...
    [LoggerMessage(LogLevel.Error, "Could not fetch input for {Challenge} {Year} {Day}{Part}{Module}: {Error}")]
    static partial void LogInputFetchFailed(ILogger logger, string challenge, uint year, uint day, string part, string module, string error);
